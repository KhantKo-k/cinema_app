...
class FailureInterpretationHelper{
  ...
  FailureInterpretation fromUnauthorized(UnauthorizedException exception) {
    String displayMessage = "Lights, Camera... Identity? Please sign in to book your seat.";
    
    if (exception.exception is FirebaseAuthException) {
      final firebaseError = exception.exception as FirebaseAuthException;
      displayMessage = firebaseError.message ?? "Authentication failed. Please check your credentials.";
    }
